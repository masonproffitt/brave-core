...
TEST_F(BatAdsUserActivityFrequencyCapTest,
  ...
  get_user_activity()->RecordActivityForType(
      UserActivityType::kOpenedNewTab);
  get_user_activity()->RecordActivityForType(
...
TEST_F(BatAdsUserActivityFrequencyCapTest,
    AllowAdIfActivityWasReportedForMoreThanTwoDifferentTypes) {
  // Arrange
  get_user_activity()->RecordActivityForType(
      UserActivityType::kOpenedNewTab);
  get_user_activity()->RecordActivityForType(
...
TEST_F(BatAdsUserActivityFrequencyCapTest,
    DoNotAllowAdIfActivityWasReportedForTwoOfTheSameType) {
  // Arrange
  get_user_activity()->RecordActivityForType(
      UserActivityType::kOpenedNewTab);
  get_user_activity()->RecordActivityForType(
...
TEST_F(BatAdsUserActivityFrequencyCapTest,
    DoNotAllowAdIfTheSameActivityWasReportedForMoreThanTwoTypes) {
  // Arrange
  get_user_activity()->RecordActivityForType(
      UserActivityType::kOpenedNewTab);
  get_user_activity()->RecordActivityForType(
